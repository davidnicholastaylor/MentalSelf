...
namespace MentalSelf.Migrations
{
    ...
    [Migration("20190307213619_QTLink")]
    partial class QTLink
    {
            ...
            modelBuilder.Entity("MentalSelf.Models.QuestionType", b =>
                {
                    ...
                    b.HasData(
                        new { QuestionTypeId = 1, QTLink = "", Threshold = 2, Type = "Depression" },
                        new { QuestionTypeId = 2, QTLink = "", Threshold = 2, Type = "Anger" },
                        new { QuestionTypeId = 3, QTLink = "", Threshold = 2, Type = "Mania" },
                        new { QuestionTypeId = 4, QTLink = "", Threshold = 2, Type = "Anxiety" },
                        new { QuestionTypeId = 5, QTLink = "", Threshold = 2, Type = "Somatic Symptoms" },
                        new { QuestionTypeId = 6, QTLink = "", Threshold = 1, Type = "Suicidal Ideation" },
                        new { QuestionTypeId = 7, QTLink = "", Threshold = 1, Type = "Psychosis" },
                        new { QuestionTypeId = 8, QTLink = "", Threshold = 2, Type = "Sleep Problems" },
                        new { QuestionTypeId = 9, QTLink = "", Threshold = 2, Type = "Memory" },
                        new { QuestionTypeId = 10, QTLink = "", Threshold = 2, Type = "Repetative Thoughts and Behaviors" },
                        new { QuestionTypeId = 11, QTLink = "", Threshold = 2, Type = "Dissociation" },
                        new { QuestionTypeId = 12, QTLink = "", Threshold = 2, Type = "Personality Functioning" },
                        new { QuestionTypeId = 13, QTLink = "", Threshold = 1, Type = "Substance Use" },
                        new { QuestionTypeId = 14, QTLink = "", Threshold = 1, Type = "Inattention" },
                        new { QuestionTypeId = 15, QTLink = "", Threshold = 2, Type = "Irritability" },
                        new { QuestionTypeId = 16, QTLink = "", Threshold = 2, Type = "Anger and Irritability" }
                    );
                });
